...
@section('body')
        ...
        <form class="form-inline" method="GET" action="{{route('search.result')}}">
          ...
          <div class="form-group">
            ...
            <select class="select_option_list" required="" name="select_option_list" >
              ...
              <option value="blood">Blood</option>
                  ...
                  <div class="form-group">
                    <input style="width:400px;" type="text" name="search_input" placeholder="Search for Doctor" class="select_option_list place_holder_input" required="required"/>
                  </div>
                  <div class="form-group">
                    <button type="submit" name="search_button" class="btn btn-md">Search</button>
                  </div>
                </form>
              </div>
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">
                <h2><span>We provide better service</span></h2>
              </div>
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
                <p>Get your desire Doctors, Hospitals, Ambulances,Bloods </p>
              </div>
            </div>
          </div>
